...
class Aba2:
    ...
    def add_itens_orc(self):
        ...
        if id_orc == '':
            msg = 'Para insertar un artículo es necesario que un presupuesto u O.S ' \
                  'estar abierto !!! clickea en' \
                  'grabar para abrir un nuevo ticket o buscar para editar uno ya' \
                  'existente.'
